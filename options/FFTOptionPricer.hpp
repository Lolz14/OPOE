 ...
 * @brief Defines the FFTPricer class for option pricing using the Fast Fourier Transform (FFT) method.
 *
 * This header provides the FFTPricer class template, which implements option pricing via FFT,
...
/**
 * @brief FFTPricer class for pricing options using Fast Fourier Transform (FFT).
 *
...
class FFTPricer : public BaseOptionPricer<R> {
    ...
    public:
        /**
         * @brief Constructs an FFTPricer instance.
